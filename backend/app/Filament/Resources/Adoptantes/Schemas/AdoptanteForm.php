        ...
        return $schema
            ->components([
                Wizard::make([
                    ...
                    Step::make('Información del Hogar')
                    ...
                    // ===== PASO 3: OTROS ANIMALES =====
                    Step::make('Otros Animales')
                    ...
                    // ===== PASO 4: PLANES FUTUROS Y ESTADO =====
                    Step::make('Planes Futuros')
                        ->icon('heroicon-m-clock')
                        ->description('Compromiso a largo plazo con el animalito')
                        ->schema([

...
<body>
    ...
    <div class="section">
        ...
        <div class="field">
            ...
            <span class="field-value">{{ $pet->especie }}</span>
        </div>
        <div class="field">
        ...
        <div class="field">
            ...
            <span class="field-value">{{ $pet->raza ?? 'Mestizo' }}</span>
        </div>
        <div class="field">
        ...
        <div class="field">
            ...
            <span class="field-value">{{ $pet->edad ? $pet->edad . ' años' : 'Desconocida' }}</span>
        </div>
        <div style="margin-top: 10px;">
            <span class="field-label">Historia y cuidados especiales:</span>
            <div style="border: 1px solid #333; min-height: 40px; padding: 5px; margin-top: 5px;">
                {{ strip_tags($pet->historia) ?? 'Sin información adicional' }}
            </div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="field">
            <span class="field-label">Edad:</span>
            <span class="field-value">{{ $adoptante->edad }} años</span>
        </div>
        <div style="margin-top: 10px;">
            <div class="field-label">Domicilio:</div>
            <div class="field">
                <span class="field-label">Dirección:</span>
                <span class="field-value">{{ $adoptante->domicilio }}</span>
            </div>
            <div class="field">
                <span class="field-label">Localidad:</span>
                <span class="field-value">{{ $adoptante->localidad }}</span>
            </div>
        </div>
        <div class="field">
    ...
    <div class="section">
        ...
        <div class="clause">
            <strong>1.</strong> El/la adoptante deberá contar con vivienda propia o en alquiler estable, quedando excluidas viviendas temporales, prestadas o con riesgo de desalojo.
        </div>
        <div class="clause">
    ...
    <div class="section">
        ...
        <div class="clause">
            ...
            <span class="checkbox">☐</span> <span class="field-value">{{ $contract['compensacion'] ?? '___________' }}</span> Pesos Argentinos, 
        ...
        <div class="clause">
            ...
            <span class="checkbox">☐</span> <span class="field-value">{{ $contract['multa'] ?? '___________' }}</span> Pesos Argentinos.
        </div>
    ...
    <div class="signature-section">
        <div class="signature-box">
            <div><strong>Por la entidad – Responsable:</strong></div>
            <div class="signature-line"></div>
            <div>Nombre y firma: {{ $contract['responsable_nombre'] ?? '_________________________' }}</div>
            <div>Fecha: {{ $contract['fecha'] }}</div>
        </div>
        <div class="signature-box">

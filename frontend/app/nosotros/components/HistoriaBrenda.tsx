      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="inline-block bg-pink-50 text-primary px-4 py-1.5 rounded-full text-xs font-bold mb-4 uppercase tracking-wider">
              La Cara Visible Hoy
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col gap-4">
            <span className="inline-block bg-pink-50 text-primary px-3 py-1 rounded-full text-xs font-bold w-fit">Los Primeros Años</span>
            <h3 className="furs-title-md text-foreground leading-tight">Desde los 5 años, rescatando</h3>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="flex flex-col gap-4">
            <span className="inline-block bg-pink-50 text-primary px-3 py-1 rounded-full text-xs font-bold w-fit">La Transformación</span>
            <h3 className="furs-title-md text-foreground leading-tight">A los 16 años, ya más de 100 vidas</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="flex flex-col gap-4 mt-8 lg:mt-0">
            <span className="inline-block bg-pink-50 text-primary px-3 py-1 rounded-full text-xs font-bold w-fit">La Activista Digital</span>
            <h3 className="furs-title-md text-foreground leading-tight">Redes sociales como herramienta de lucha</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="flex flex-col gap-4 mt-8 lg:mt-0">
            <span className="inline-block bg-pink-50 text-primary px-3 py-1 rounded-full text-xs font-bold w-fit">El Legado</span>
            <h3 className="furs-title-md text-foreground leading-tight">Continuidad del legado de Ana Lía</h3>
            <p className="text-sm text-gray-600 leading-relaxed">
